...
module Network.AWS.SWF.RespondActivityTaskCanceled where
...
instance AWSRequest RespondActivityTaskCanceled where
    type Er RespondActivityTaskCanceled = SWFError
...
instance FromJSON RespondActivityTaskCanceledResponse where
