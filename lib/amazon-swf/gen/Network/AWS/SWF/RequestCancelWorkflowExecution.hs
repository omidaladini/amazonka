...
module Network.AWS.SWF.RequestCancelWorkflowExecution where
...
instance AWSRequest RequestCancelWorkflowExecution where
    type Er RequestCancelWorkflowExecution = SWFError
...
instance FromJSON RequestCancelWorkflowExecutionResponse where
