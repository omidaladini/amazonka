...
data Version = Version
    { xETag :: Maybe Text
    , xIsLatest :: Maybe Bool
      -- ^ Specifies whether the object is (true) or is not (false) the latest version
      -- of an object.
    , xKey :: Maybe Text
      -- ^ The object key.
    , xLastModified :: Maybe UTCTime
      -- ^ Date and time the object was last modified.
    , xOwner :: Maybe Owner
    , xSize :: Maybe Text
      -- ^ Size in bytes of the object.
    , xStorageClass :: Maybe StorageClass
      -- ^ The class of storage used to store the object.
    , xVersionId :: Maybe Text
...
data Upload = Upload
    { wInitiated :: Maybe UTCTime
      -- ^ Date and time at which the multipart upload was initiated.
    , wInitiator :: Maybe Initiator
      -- ^ Identifies who initiated the multipart upload.
    , wKey :: Maybe Text
      -- ^ Key of the object for which the multipart upload was initiated.
    , wOwner :: Maybe Owner
    , wStorageClass :: Maybe StorageClass
      -- ^ The class of storage used to store the object.
    , wUploadId :: Maybe Text
...
data Rule = Rule
    { sExpiration :: Maybe Expiration
    , sID :: Maybe Text
      -- ^ Unique identifier for the rule. The value cannot be longer than 255
      -- characters.
    , sPrefix :: Maybe Text
      -- ^ Prefix identifying one or more objects to which the rule applies.
    , sStatus :: Maybe Status
      -- ^ If 'Enabled', the rule is currently being applied. If 'Disabled', the rule
      -- is not currently being applied.
    , sTransition :: Maybe Transition
    } deriving (Eq, Show, Generic)
...
data Grantee = Grantee
    { jDisplayName :: Maybe Text
      -- ^ Screen name of the grantee.
    , jEmailAddress :: Maybe Text
...
data Grant = Grant
    { iGrantee :: Maybe Grantee
    , iPermission :: Maybe Text
    } deriving (Eq, Show, Generic)
...
data Deleted = Deleted
    { fDeleteMarker :: Maybe Bool
    , fDeleteMarkerVersionId :: Maybe Text
    , fKey :: Maybe Text
    , fVersionId :: Maybe Text
    } deriving (Eq, Show, Generic)
...
data Contents = Contents
    { dETag :: Maybe Text
    , dKey :: Maybe Text
    , dLastModified :: Maybe UTCTime
    , dOwner :: Maybe Owner
    , dSize :: Maybe Int
    , dStorageClass :: Maybe StorageClass
      -- ^ The class of storage used to store the object.
    } deriving (Eq, Show, Generic)
