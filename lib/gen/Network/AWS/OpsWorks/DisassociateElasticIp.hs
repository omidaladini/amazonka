...
-- User Permissions.
module Network.AWS.OpsWorks.DisassociateElasticIp where
...
disassociateElasticIp :: Text
                      -> AWS (Either OpsWorksError DisassociateElasticIpResponse)
disassociateElasticIp p1 = undefined $ DisassociateElasticIp
    { deirElasticIp = p1
    }
...
instance AWSRequest DisassociateElasticIp where
    type Er DisassociateElasticIp = OpsWorksError
...
instance FromJSON DisassociateElasticIpResponse
