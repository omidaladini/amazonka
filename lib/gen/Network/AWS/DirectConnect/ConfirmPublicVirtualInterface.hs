...
confirmPublicVirtualInterface :: Text
                              -> AWS (Either DirectConnectError ConfirmPublicVirtualInterfaceResponse)
confirmPublicVirtualInterface p1 = undefined $ ConfirmPublicVirtualInterface
    { cpvitVirtualInterfaceId = p1
    }
