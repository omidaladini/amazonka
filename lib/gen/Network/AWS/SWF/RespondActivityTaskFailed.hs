...
module Network.AWS.SWF.RespondActivityTaskFailed where
...
respondActivityTaskFailed :: Text
                          -> AWS (Either SWFError RespondActivityTaskFailedResponse)
respondActivityTaskFailed p1 = undefined $ RespondActivityTaskFailed
    { ratfiTaskToken = p1
    , ratfiDetails = Nothing
    , ratfiReason = Nothing
    }

data RespondActivityTaskFailed = RespondActivityTaskFailed
    { ratfiDetails :: Maybe Text
      -- ^ Optional detailed information about the failure.
    , ratfiReason :: Maybe Text
...
instance AWSRequest RespondActivityTaskFailed where
    type Er RespondActivityTaskFailed = SWFError
...
instance FromJSON RespondActivityTaskFailedResponse
