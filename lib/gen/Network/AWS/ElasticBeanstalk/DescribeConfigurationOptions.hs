...
module Network.AWS.ElasticBeanstalk.DescribeConfigurationOptions where
...
instance AWSRequest DescribeConfigurationOptions where
    type Er DescribeConfigurationOptions = ElasticBeanstalkError
    type Rs DescribeConfigurationOptions = DescribeConfigurationOptionsResponse
    request = getQuery service "DescribeConfigurationOptions"

data DescribeConfigurationOptionsResponse = DescribeConfigurationOptionsResponse
    { dcomrsOptions :: [ConfigurationOptionDescription]
      -- ^ A list of ConfigurationOptionDescription.
    , dcomrsSolutionStackName :: Maybe Text
