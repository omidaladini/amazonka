...
-- User Permissions.
module Network.AWS.OpsWorks.AssociateElasticIp where
...
instance AWSRequest AssociateElasticIp where
    type Er AssociateElasticIp = OpsWorksError
...
instance FromJSON AssociateElasticIpResponse where
