...
-- }.
module Network.AWS.StorageGateway.CreateCachediSCSIVolume where
...
data CreateCachediSCSIVolume = CreateCachediSCSIVolume
    ...
    , ccscsiviNetworkInterfaceId :: !Text
    , ccscsiviSnapshotId :: Maybe Text
    , ccscsiviTargetName :: !Text
    , ccscsiviVolumeSizeInBytes :: !Integer
...
instance AWSRequest CreateCachediSCSIVolume where
    type Er CreateCachediSCSIVolume = StorageGatewayError
...
data CreateCachediSCSIVolumeResponse = CreateCachediSCSIVolumeResponse
    { ccscsivirsTargetARN :: Maybe Text
    , ccscsivirsVolumeARN :: Maybe Text
    } deriving (Eq, Show, Generic)
