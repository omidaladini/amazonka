...
-- Module      : Network.AWS.Generics.Query
...
module Network.AWS.Generics.Query where
...
decodeQuery :: FromQuery a => [(Text, Text)] -> Either String a
...
encodeQuery :: ToQuery a => a -> [(Text, Text)]
